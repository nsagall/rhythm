...
- If a member variable does need a comment, it should go above the variable declaration.  If there is a variable declaration above it, there should be an empty line above the start of the comment 
