...
// actually there.
inline COLORREF kNeutral = RGB(150, 150, 170);
...
inline COLORREF kBgTop = RGB(46, 20, 92);
inline COLORREF kBgBottom = RGB(15, 11, 42);
inline COLORREF kBorderColor = RGB(120, 90, 190);
inline COLORREF kTextColor = RGB(255, 250, 240);
inline COLORREF kStreakColor = RGB(255, 205, 70); // still used as one of the confetti burst's colors
...
inline COLORREF kPanelBgColor = RGB(12, 8, 28);
...
inline COLORREF kShadowColor = RGB(0, 0, 0);
inline COLORREF kHighlightWhite = RGB(255, 255, 255);
...
inline COLORREF kNoteColorHit = RGB(40, 235, 80);
inline COLORREF kNoteColorMiss = RGB(255, 30, 30);
...
inline COLORREF kNoteColorHitImprecise = RGB(255, 205, 40);
...
// editable from kStreakColor/kHighlightWhite even though two entries here
// happen to start out matching them - Colors.ini can drift them apart.
inline COLORREF kConfettiPalette[] = {
...
inline COLORREF kScorePopupBankedColor = RGB(255, 215, 90);
...
inline COLORREF kWindowBgColor = RGB(15, 11, 30);
inline COLORREF kFieldBgColor = RGB(30, 23, 56);
inline COLORREF kLabelTextColor = RGB(230, 222, 245);
inline COLORREF kRefreshButtonColor = RGB(255, 205, 70);
inline COLORREF kAssignButtonColor = RGB(150, 220, 140);
inline COLORREF kSongRowHighlightColor = RGB(56, 219, 255);
inline COLORREF kSongRowHighlightTextColor = RGB(10, 10, 20);
inline COLORREF kHintTextColor = RGB(150, 140, 175);
// Independently editable from kFieldBgColor/kSongRowHighlightColor even
// though they start out matching (see kConfettiPalette's own comment).
inline COLORREF kToggleTrackOffColor = RGB(30, 23, 56);
inline COLORREF kToggleTrackOnColor = RGB(56, 219, 255);
inline COLORREF kToggleKnobColor = RGB(245, 242, 250);
