...
private:
    ...
    // NextOnsetAfter/FirstReachableOnset/FirstReachableOnsetForAllLanes
    // moved to ChartTiming.h (shared with the editor's analytical block
    // scheduler) - see that header for their doc comments.
